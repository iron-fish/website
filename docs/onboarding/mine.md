...
## Join a mining pool
You can also join a mining pool in order to increase your chances of mining a block. Block rewards are typically split among miners based on their respective contributions. We run a basic mining pool that anyone can join! To get started, retrive the public key of the account you want to use:
