...
This is very much a work in progress, however, our thinkings and intuition around choosing the appropriate coin emission graph can be found [here](https://docs.google.com/document/d/1WjKRXHltLivcN08wiGfPrDsiBa7jgXeNlr1rOWEushg/edit#heading=h.kv49wpvtizgb).
...
*   [The Case for Electronic Cash](https://www.coincenter.org/the-case-for-electronic-cash/) by Coincenter (with edits from Elena from Iron Fish (previously called Beanstalk))
