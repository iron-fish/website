      ...
      <div className={className}>
        <div
          className={`flex justify-center ${
            condensed ? 'flex-col' : `border-0 border-b border-t border-solid border-iflightgray flex-row`
          }`}
        >
          <div
            className={`flex ${
              condensed ? `justify-start p-4` : `justify-end border-0 border-r border-solid border-iflightgray p-8 pb-10`
            }`}
          >
            <div style={{ maxWidth: condensed ? undefined : '14rem' }}>
              <SectionHeader>IRON FISH CLI</SectionHeader>
              <div className="text-ifgray">
                <h4 className={`text-xl text-black mb-1 ${overrides.testnetH4}`}>Installation Guide</h4>
                <p className="font-favorit text-sm mb-2">
                  An in-depth walkthrough of how to set up Iron Fish on your
                  machine.
                </p>
                  <a href="https://ironfish.network/docs/onboarding/iron-fish-tutorial" className={`flex font-favorit text-sm ${overrides.link}`}>
