...
const LAUNCH_DATE = new Date('2021-09-10T00:01:00.000Z')

const updateTimeRemaining = () => {
  const now = new Date()

  if (now > LAUNCH_DATE) {
    return { daysText: '0 days', hoursText: '0 hours', minutesText: '0 minutes' }
  }
...
const TestnetBanner = () => {
  ...
  return (
    <div style={{
      ...
      <span>Our Incentivized Testnet starts in {time.daysText}, {time.hoursText}, and {time.minutesText}.&nbsp;
      <a style={{ color: '#5141C9', textDecoration: 'none' }} href="https://ironfish.network">Learn More</a></span>
    </div>
  )
}
