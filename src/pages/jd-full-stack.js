...
function JDBackend() {
  return (
    <JobLayout locationJob="SF/Remote" title="Full Stack Engineer">
      <p>
        Full Stack Engineers at Iron Fish work cross-functionally—collaborating
      ...
      <JobLayoutSection title="Nice to haves">
        <ul>
          <li>You’ve worked with React, React Native, Typescript</li>
          <li>
