...
- **Emissions Curve:** TheEmissions curve describes how the total supply changes over time due to token economics. For Iron Fish, every time a miner mines a block, they are rewarded with new coins that contribute to an inflation schedule, meaning that with each block the total supply of tokens increases. More on the emissions curve below.
...
<Img src="/images/tokenomics/06-circulating-supply.avif" alt="" />
...
<Img src="/images/tokenomics/07-distribution-12-mo.avif" alt="" />

<Img src="/images/tokenomics/08-distribution-24-mo.avif" alt="" />

<Img src="/images/tokenomics/09-distribution-36-mo.avif" alt="" />

<Img src="/images/tokenomics/10-distribution-48-mo.avif" alt="" />
