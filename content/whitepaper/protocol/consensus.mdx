...
| `enableAssetOwnership`       | Whether ownership of assets can be transferred between accounts (see [Changing asset ownership](transactions#changing-asset-ownership))                                                                                                                                                                                                                                                                                                                                                                                                            | Hard Fork 1 | TBD                      | TBD                      |
| `enforceSequentialBlockTime` | Whether block timestamps must be strictly monotonic (non-decreasing)                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Hard Fork 1 | TBD                      | TBD                      |
