...
| enableAssetOwnership | Whether ownership of assets can be transferred between accounts (see [Changing asset ownership](transactions#changing-asset-ownership)) | Hard Fork 1 [link to FIP] | TBD | TBD |
