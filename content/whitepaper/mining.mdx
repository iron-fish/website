...
- <em>Mining</em> is the core mechanism that defines by which rules new blocks are
  created, and by which rules a peer can verify and accept an incoming block.
- <em>Miners</em> are those nodes that propose a new block to be added to the blockchain
  to other nodes.
...
<Img
  src="/images/whitepaper/mining/emissions_curve.svg"
  width="100%"
  role="presentation"
