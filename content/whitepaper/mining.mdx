...
<Img src ="/images/whitepaper/mining/emissions_curve.svg" width="100%" role="presentation" style={{paddingRight:'25px'}} />
...
After determining the block body, the miner can then construct the [block header](/learn/whitepaper/storage#block-header) for it.
...
| **previousBlockHash**   | The **previousBlockHash** is filled out using the hash of the latest block in the blockchain, per the [Iron Fish hashing algorithm](/learn/whitepaper/mining#iron-fish-hashing-algorithm). This indicates that this new block is building off of the latest known block in the blockchain.                                                                                      |
...
| **target**              | The **target** is determined by the [difficulty and target algorithm](/learn/whitepaper/mining#set-the-difficulty-and-target-for-a-block).                                                                                                                                                                                                                                      |
...
| **randomness**          | The **randomness** is a 64-bit number such that when all the contents of the block header are hashed using the [Iron Fish hashing algorithm](/learn/whitepaper/mining#iron-fish-hashing-algorithm) the result is numerically less than the target.                                                                                                                              |
