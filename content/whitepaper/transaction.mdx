...
seo-title: Secure and Fast Transactions
---
...
<Img src='/images/whitepaper/transaction/transaction1.svg' width="100%" style={{paddingTop:'10px'}} />
...
| $$cv$$      |                                                                                             value commitment                                                                                             |
| $$cm$$      |                                                                                             note commitment                                                                                              |
| $$epk$$     |                                         ephemeral public key (more on this in [Note Encryption and Decryption](/learn/whitepaper/transaction#note-encryption-and-decryption))                                         |
| $$C^\{enc\}$$ |                                                                                     encrypted plaintext of the note                                                                                      |
| $$C^\{out\}$$ | encrypted blob that allows the holder of the viewing key to decrypt a decryption key for $$C^\{enc\}$$ (more on this in [Note Encryption and Decryption](/learn/whitepaper/transaction#note-encryption-and-decryption)) |
...
| $$esk$$  | ephemeral private key — a random number chosen by the sender (more on this in the [Note Encryption and Decryption section](/learn/whitepaper/transaction#note-encryption-and-decryption) |
...
The outputs in the Output description are stored as a [Merkle Tree Note](/learn/whitepaper/storage#merkle-tree-of-notes) in addition to being part of the transaction.
...
- **Spends**: the list of [Spend Descriptions](/learn/whitepaper/transaction#spend-description)
- **Outputs**: the list of [Output Descriptions](/learn/whitepaper/transaction#output-description)
- **Binding Signature**: a binding signature that both signs the transaction and is used to [verify](/learn/whitepaper/transaction#transaction-verification) that it [balances](/learn/whitepaper/transaction#transaction-balancing)
...
1. Verify all the zero-knowledge proofs against the public parameters from the [Spend description](/learn/whitepaper/transaction#spend-description)
...
3. Check that the [transaction balances](/learn/whitepaper/transaction#transaction-balancing)
