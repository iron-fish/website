---
title: Networking (WIP, links need to be updated)
...
- distributing pending [transactions](https://www.notion.so/Transactions-0d0b05511fb8401881d6493fe30b57db?pvs=21) and blocks
...
These parameters cannot be changed. Attempting to change these parameters would result in a new network. Therefore, these specific network definitions are considered to be part of [consensus](https://www.notion.so/Consensus-3eb91b5d0cba4b12b6ac76a254ebd597?pvs=21). 
...
| Message Type | Message Numerical Number | Description |
| --- | --- | --- |
...
For full description of all message types and exact formats, see [here](https://github.com/iron-fish/ironfish/tree/v1.11.0/ironfish/src/network/messages).
