...
You can read about the different wallet commands in [the wallet section](/use/get-started/wallet-commands).

Now that you have created an account you can [receive transactions](/use/get-started/transactions#receive-a-transaction) or [start mining $IRON](/use/get-started/mining).
