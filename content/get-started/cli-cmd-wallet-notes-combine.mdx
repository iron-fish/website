...
You can specify the combined note to be sent in a different transaction using the `--note` flag: 

```sh
ironfish wallet:send --note 72e91d6672d79f9006f128a16cf52bbb585037fee2aea8385b56919c3ac9570b
```

In order to find the combined note, you can use the `wallet:notes` command:

```sh
ironfish wallet:notes --filter="Spent=x"
```
