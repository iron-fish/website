...
The Iron Fish CLI also supports solo mining with most of the available mining softwares. After [installing](/use/get-started/installation) the CLI, [start](http://localhost:3000/use/get-started/run-a-node) your node and make sure it is synced before starting a local mining pool.
...
You should then be able to connect your miner to `http://localhost:9034` and start mining.
