...
Please check out the pool websites for instructions on how to join that pool.
 ...
 * Multi Mining: Yes, Iron+ETHW, IRON+ETC, IRON+ERG

 ### F2Pool
 * Payment Model: PPLNS
 * Fees: 1%
 * Miners: IRONMiner, BzMiner, SRBMiner
 * How do I join?: https://f2pool.io/mining/guides/how-to-mine-iron-fish/
 * Multi Mining: No
 ...
 * Payment Model: ???
 * Fees: 0.9%
 * Miners: SRBMiner, BzMiner, Rigel, TeamRedMiner, lolMiner, GMiner
 * How do I join?: https://ironfish.herominers.com/#how-to-mine-ironfish-iron
 * Multi Mining: Yes, IRON+ERG, IRON+ETC
 ...
 * Fees: 0.7%
 * Miners: ???
 * How do I join?: https://www.tw-pool.com/
 * Multi Mining: No
 ...
 * Fees: 0.5%
 * Miners: ???
 * How do I join?: https://hashpool.com/
 * Multi Mining: No
