...
<Terminal
  command="ironfish wallet:use MyAccount"
  output={`
...
<Terminal
  command="ironfish wallet:export wallet"
  output={`
...
<Terminal
  command="ironfish wallet:address"
  output={`
...
<Terminal
  command="ironfish wallet:assets"
  output={`
...
<Terminal
  command="ironfish wallet:balances"
  output={`
Account: default
...
<Terminal
  command="ironfish wallet:delete wallet"
  output={`
...
<Terminal
  command="ironfish wallet:rescan"
  output={`
