...
This guide is intended for people new to crypto to understand what Iron Fish is and how they can get started using it. If you want to skip directly to installing and running Iron Fish, you can [install a node](/developers/documentation/install-npm) now.
...
[Install a node.](/developers/documentation/install-npm)
