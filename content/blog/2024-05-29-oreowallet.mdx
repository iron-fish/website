...
We are thrilled to highlight in this spotlight OreoWallet, and its creator and grant recipient Fishguy. OreoWallet is an ongoing grant to build a browser extension wallet supporting Iron Fish.

We asked Fishguy how he got his start in engineering and what attracted him to crypto and specifically Iron Fish that inspired him to build this project. Let's dive in!

#### Q: What is OreoWallet?
...
#### Q: What makes OreoWallet unique?
...
Extension wallets are the most popular wallet for blockchains, and an extension wallet has benefits for the upcoming bridge applications in Iron Fish. OreoWallet can be used for those assets as well. The Node App also takes a long time to sync from scratch with limited resources, coupled with the single threaded nature of Node.js tech stack. OreoWallet wants to provide a better user experience.

#### Q: How did you get started with engineering?
...
#### Q: How did that path lead you to crypto?

We are so used to keeping our money in an organization backed by a centralized team. However, we never know who truly controls our money or if they are smarter than us. I want to keep my money in my hands— we all should. I realized Bitcoin is cool because we can manage and control our money in a decentralized manner. Iron Fish is cool as it utilizes zero-knowledge stack. ZKPs allow users to transact privately in a permissionless way. Simply amazing!

#### Q: What is the ethos of crypto and privacy that led you to be a part of Iron Fish?
...
#### Q: How long have you been in the Iron Fish community?

I have been a part of the Iron Fish community for three years, since 2021.

#### Q: Is there anything you would like to see in the wider crypto space?

Massive adoption of blockchain technology.

#### Q: What else would you like to share about yourself with the Iron Fish community?
...
To read more about the grant process, and how you can get funding from the Iron Fish Foundation to build Iron Fish related tools, please visit our grants page.