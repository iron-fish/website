...
image: /images/blog/spotlights/oreoscanspotlight.png
tags: [community-highlight]
---



[Oreoscan](https://www.oreoscan.info/en) is a community driven blockchain explorer for Iron Fish. The project was developed during the incentivized testnet phase of Iron Fish to address the community's need for a reliable block explorer for Iron Fish.

  

Users can utilize Oreoscan’s intuitive UI to explore important Iron Fish network metrics, [block](https://www.oreoscan.info/en/blocks) and [transaction](https://www.oreoscan.info/en/transactions) feeds, or take a look at network computing power and transaction fee variation [charts](https://www.oreoscan.info/en/charts).
...
To stay in the loop with Oreoscan, visit the [official website](https://www.oreoscan.info/en). You can also follow the project on [Twitter](https://twitter.com/oreoscan). Community members can look forward to regular updates, new features, and ongoing improvements based on their feedback.
