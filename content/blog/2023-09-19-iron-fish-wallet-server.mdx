...
description: 
image: /images/blog/introducing-wallet-server/hero.png
tags: [ironfish]
---
...
Light clients can request the latest block, they can request a specific block by hash or sequence, or they can request a range of blocks. The Wallet Server also provides an endpoint for light clients to submit transactions to the network.
