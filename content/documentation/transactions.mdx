...
You can also send in non interactive mode by providing flags. Run `ironfish wallet:send --help` to see the different options available. [See more here](/developers/documentation/cli/cli-cmd-wallet-send).
