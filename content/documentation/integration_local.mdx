...
description: Integration Guide | Local Development | Iron Fish Documentation
---

To test out integration or workflows, it’s generally easier to create your own
...
You can read more about our included networks in the [networks documentation](/developers/documentation/use-networks).
