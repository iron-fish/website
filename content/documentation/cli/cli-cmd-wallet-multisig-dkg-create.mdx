...
1. [`wallet:multisig:dkg:round1`](/developers/documentation/cli/cli-cmd-wallet-multisig-dkg-round1)
2. [`wallet:multisig:dkg:round2`](/developers/documentation/cli/cli-cmd-wallet-multisig-dkg-round2)
3. [`wallet:multisig:dkg:round3`](/developers/documentation/cli/cli-cmd-wallet-multisig-dkg-round3)
