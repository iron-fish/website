...
**Tip:** Make sure the unsigned transaction has a sufficient expiration time to allow for the completion of the signing process. The expiration can be set to 0 to effectively disable it (sets the expiration of the transaction to infinity). 
