...
**Note:** This action can be performed by both the participant and the dealer (in the case of Trusted Dealer Key Generation).
...
const serialized = multisig.aggregateSignatureShares(
    dealerAccount.multisigKeys.publicKeyPackage, // this can also be performed by the trusted dealer. 
    signingPackage,
