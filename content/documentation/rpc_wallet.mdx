...
The `notes` parameter is an optional list of hex strings of the hashes of notes to spend in the transaction.
...
## [wallet/getAccountsStatus](https://github.com/iron-fish/ironfish/blob/master/ironfish/src/rpc/routes/wallet/getAccountsStatus.ts)
...
## [wallet/use](https://github.com/iron-fish/ironfish/blob/master/ironfish/src/rpc/routes/wallet/use.ts)
