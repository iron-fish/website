...
const { encryptedSecretPackage, publicPackage } = multisig.round1(
  identity,
  minSigners,
...
const { encryptedSecretPackage, publicPackages } = multisig.round2(
  secret,
  encryptedSecretRound1Package,
