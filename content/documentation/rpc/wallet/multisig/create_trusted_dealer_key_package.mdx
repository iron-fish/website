...
Defines the structure of a multisig account. The result is a set of accounts to import by each participant using the RPC wallet/accountImport. It is the responsibility of the dealer to securely distribute the accounts to the participants.
