...
## [config/getConfig](https://github.com/iron-fish/ironfish/blob/master/ironfish/src/rpc/routes/config/getConfig.ts)
...
## [config/setConfig](https://github.com/iron-fish/ironfish/blob/master/ironfish/src/rpc/routes/config/setConfig.ts)
...
## [config/unsetConfig](https://github.com/iron-fish/ironfish/blob/master/ironfish/src/rpc/routes/config/unsetConfig.ts)
...
## [config/uploadConfig](https://github.com/iron-fish/ironfish/blob/master/ironfish/src/rpc/routes/config/uploadConfig.ts)
