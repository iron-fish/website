...
seo-title: Node Config Options | Node Data Directory
---
...
Configuration files can be edited by the commands described [here](/developers/documentation/cli/cli-cmd-config-set).


## Configuration

To change configuration of your node, you can do so from the command line using the [config:set command](/developers/documentation/cli/cli-cmd-config-set).
