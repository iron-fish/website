...
Iron Fish supports custom network definitions. You can create a custom network definition and import it using the [customNetwork config](/developers/documentation/node-config) or the `--customNetwork` flag like this...
